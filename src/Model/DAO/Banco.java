...
public class Banco {
    ...
    public static void inicia() {
        ...
        //criando elementos
        Usuario usuario1 = new Usuario(1, "Marcos", 'M', "09/05/1996", "30212121", "marcosfanan@gmail.com", "521454123", "Marcos", "administrador");
       

        Cliente cliente11 = new Cliente(11, "Pedro Fanan", 'M', "05/07/2001", "30212126", "p3dro1124@gmail.com", "5142487", "Rua jaboti 35 Canudos NH", "93300012");
        ...
        Servico servico1 = new Servico(1, "Manuteção", 50);
        Servico servico2 = new Servico(2, "instalação", 150);
        Servico servico3 = new Servico(3, "visita", 50);
        Servico servico4 = new Servico(4, "controles", 40);
        Servico servico5 = new Servico(5, "travas", 300);
